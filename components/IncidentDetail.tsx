                 ...
                 <div className="space-y-6">
                    <Card>
                        ...
                        <div>
                            ...
                            <div className="text-center mt-4"><Button onClick={handlePerformUnifiedAnalysis} isLoading={isUnifiedAnalyzing} disabled={isUnifiedAnalyzing || !sopFile}>بدء التحليل الموحد</Button></div>
                        </div>
                    </Card>
                </div>
            ) : (
